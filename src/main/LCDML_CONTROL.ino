...
// settings
  ...
  #define _LCDML_CONTROL_analog_enter_min        540     // Button Enter
  #define _LCDML_CONTROL_analog_enter_max        650  
  #define _LCDML_CONTROL_analog_up_min           400     // Button Up
  #define _LCDML_CONTROL_analog_up_max           480   
  #define _LCDML_CONTROL_analog_down_min         310     // Button Down
  #define _LCDML_CONTROL_analog_down_max         390   
  #define _LCDML_CONTROL_analog_back_min         100     // Button Back
  #define _LCDML_CONTROL_analog_back_max         150   
  #define _LCDML_CONTROL_analog_left_min         200     // Button Left
  #define _LCDML_CONTROL_analog_left_max         270   
  #define _LCDML_CONTROL_analog_right_min        490     // Button Right
  #define _LCDML_CONTROL_analog_right_max        530
// *********************************************************************
// setup
void LCDML_CONTROL_setup()
{
